...
export function defaultMiddlewareChain(tenants: AntboxTenant[], h: HttpHandler): HttpHandler {
	return chain(h, authenticationMiddleware(tenants), corsMiddleware, logMiddleware);
}
