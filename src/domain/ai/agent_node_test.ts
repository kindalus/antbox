...
it("AgentNode.create should initialize with required fields", () => {
...
it("AgentNode.create should use default values", () => {
	const agent = AgentNode.create({
		title: "Default Agent",
		owner: "admin@example.com",
...
it("AgentNode.create should fail if owner is missing", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
...
it("AgentNode.create should fail if systemInstructions is missing", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "",
	...
	expect(agent.isLeft()).toBeTruthy();
	expect((agent.value as ValidationError).message).toBe("Node.systemInstructions is required");
});

it("AgentNode.create should fail if temperature is out of range", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
...
it("AgentNode.create should fail if maxTokens is invalid", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.create should accept structuredAnswer", () => {
...
it("AgentNode.update should modify model", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should modify temperature", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should modify maxTokens", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should modify reasoning", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should modify useTools", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should modify systemInstructions", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
...
it("AgentNode.update should modify structuredAnswer", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should fail if temperature is out of range", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should fail if systemInstructions is empty", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.update should not modify parent", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode.toJSON should return complete metadata", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
...
it("AgentNode should generate uuid if not provided", () => {
	const agent = AgentNode.create({
		title: "Test Agent",
		owner: "admin@example.com",
		systemInstructions: "Test",
...
it("AgentNode should use provided uuid", () => {
	const agent = AgentNode.create({
...
it("AgentNode should validate title length", () => {
	const agent = AgentNode.create({
		title: "AB",
		owner: "admin@example.com",
		systemInstructions: "Test",
