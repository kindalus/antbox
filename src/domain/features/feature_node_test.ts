...
describe("FeatureNode", () => {
	describe("create", () => {
		...
		it("should set default array and object values", () => {
			const result = FeatureNode.create({
				title: "Test Feature",
				parent: Folders.FEATURES_FOLDER_UUID,
				owner: "user@domain.com",
		...
		it("should always have FEATURE_MIMETYPE", () => {
			const result = FeatureNode.create({
				title: "Test Feature",
		...
		it("should inherit from FileMixin", () => {
			const result = FeatureNode.create({
	...
	describe("configuration", () => {
		it("should set default return type to void", () => {
			const result = FeatureNode.create({
				title: "Test Feature",
				parent: Folders.FEATURES_FOLDER_UUID,
				owner: "user@domain.com",
		...
		it("should handle security and execution configurations", () => {
			const result = FeatureNode.create({
		...
		it("should handle exposure configurations", () => {
			const parameters: FeatureParameter[] = [
				{
					name: "uuids",
					type: "array",
		...
		it("should require 'uuids' parameter when exposed as action", () => {
		...
		it("should validate uuids parameter type for actions", () => {
		...
		it("with file parameter should be exposed as extension only", () => {
		...
		it("with array of files parameter should be exposed as extension only", () => {
	...
	describe("validation", () => {
		it("should return error if name and title are missing", () => {
			const result = FeatureNode.create({
				parent: Folders.FEATURES_FOLDER_UUID,
				owner: "user@domain.com",
				mimetype: Nodes.FEATURE_MIMETYPE,
		...
		it("should return error if owner is missing", () => {
			const result = FeatureNode.create({
				title: "Test Feature",
				parent: Folders.FEATURES_FOLDER_UUID,
				mimetype: Nodes.FEATURE_MIMETYPE,
		...
		it("should fail if file parameter is exposed as action", () => {
			const parametersWithFile: FeatureParameter[] = [
				{
					name: "inputFile",
					type: "file",
		...
		it("should fail if file parameter is exposed as AI tool only", () => {
			const parametersWithFile: FeatureParameter[] = [
				{
					name: "inputFile",
					type: "file",
		...
		it("should fail if array of files parameter is exposed as action", () => {
			const parametersWithFileArray: FeatureParameter[] = [
				{
					name: "inputFiles",
					type: "array",
		...
		it("should fail if array of files parameter is exposed as AI tool only", () => {
			const parametersWithFileArray: FeatureParameter[] = [
				{
					name: "inputFiles",
					type: "array",
	...
	describe("metadata", () => {
		it("should initialize with minimal metadata", () => {
			const result = FeatureNode.create({
				title: "Test Feature",
				parent: Folders.FEATURES_FOLDER_UUID,
				owner: "user@domain.com",
		...
		it("should initialize with full metadata", () => {
			const parameters: FeatureParameter[] = [
				{
					name: "input",
					type: "string",
		...
		it("should include all properties in metadata", () => {
			const parameters: FeatureParameter[] = [
				{
					name: "uuids",
					type: "array",
