Excellent question. To be more aligned with a **modern, lightweight ECM**, Antbox needs to focus on making its powerful backend capabilities accessible and useful to business users, not just developers.
