...
Deno.test("ParentFolderUpdateHandler - should update parent folder modification time when node is deleted", async () => {
	const mockContext = createMockContext();
	const mockRepo = mockContext.repository as unknown as MockNodeRepository;
	const handler = new ParentFolderUpdateHandler(mockContext);
...
Deno.test("ParentFolderUpdateHandler - should not update root folder", async () => {
	const mockContext = createMockContext();
	const handler = new ParentFolderUpdateHandler(mockContext);
...
Deno.test("ParentFolderUpdateHandler - should handle parent not found gracefully", async () => {
	const mockContext = createMockContext();
	const handler = new ParentFolderUpdateHandler(mockContext);
...
Deno.test("ParentFolderUpdateHandler - should handle repository update failure gracefully", async () => {
	const mockContext = createMockContext();
	const mockRepo = mockContext.repository as unknown as MockNodeRepository;
...
Deno.test("ParentFolderUpdateHandler - should update parent folder modification time when node is updated", async () => {
	const mockContext = createMockContext();
	const mockRepo = mockContext.repository as unknown as MockNodeRepository;
	const handler = new ParentFolderUpdateHandler(mockContext);
...
Deno.test("ParentFolderUpdateHandler - should update both old and new parent folders when node is moved", async () => {
	const mockContext = createMockContext();
	const mockRepo = mockContext.repository as unknown as MockNodeRepository;
	const handler = new ParentFolderUpdateHandler(mockContext);
...
Deno.test("ParentFolderUpdateHandler - should update parent when node properties are updated", async () => {
	const mockContext = createMockContext();
	const mockRepo = mockContext.repository as unknown as MockNodeRepository;
	const handler = new ParentFolderUpdateHandler(mockContext);
