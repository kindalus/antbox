...
function buildActionsFolder(): FolderNode {
	return FolderNode.create(createSystemFolderMetadata(
...
function buildFormSpecificationsFolder(): FolderNode {
	return FolderNode.create(createSystemFolderMetadata(
...
const FORMS_SPECIFICICATIONS_FOLDER = buildFormSpecificationsFolder();
